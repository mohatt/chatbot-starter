...
type ExplodeMetadata<T> = T extends any
...
type BucketsForNS<N extends UploadNS> = Extract<
  UploadPayloadExploded,
  { metadata: { namespace: N } }
>['bucket']
type MetadataForNS<N extends UploadNS> = Extract<
  UploadPayloadExploded['metadata'],
  { namespace: N }
>
        ...
        return {
          ...
          types: {
            ...
            extensions: Array.from(
              new Set(buckets.flatMap((bid) => allBuckets[bid].types.extensions)),
            ),
          },
          title: 'Upload files',
        } as const
