...
const chatMetadataSchema = chatStorageMetadataSchema.omit({ bucket: true })

const projectMetadataSchema = projectStorageMetadataSchema.omit({ bucket: true })
...
const fileUploadSchema = z.discriminatedUnion('bucket', [
  z.strictObject({
    ...
    metadata: z.discriminatedUnion('namespace', [chatMetadataSchema, projectMetadataSchema]),
  }),
  z.strictObject({
    id: uuidV7,
