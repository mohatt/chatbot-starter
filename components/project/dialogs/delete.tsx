...
import { useDeleteProjectMutation } from '@/api/mutations/projects'
...
export function DeleteProjectDialog(props: DeleteProjectDialogProps) {
  ...
  return (
    <AlertDialog
      ...
      description={<>This will delete <b>{name}</b> project.</>}
      submit='Delete'
      variant='destructive'
    ...
    >
      <Alert variant='destructive'>
        ...
        <AlertDescription>
          <p>
            This will also permanently delete any chats
            under this project and their history from our servers.
